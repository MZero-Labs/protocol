...
contract MTokenTests is TestUtils {
    ...
    function test_mint_invalidRecipient() external {
        ...
        vm.expectRevert(abi.encodeWithSelector(IERC20Extended.InvalidRecipient.selector, address(_mToken)));

        vm.prank(_minterGateway);
        _mToken.mint(address(_mToken), 1_000);
    }
    ...
    function test_transfer_invalidRecipient() external {
        ...
        vm.prank(_alice);
        _mToken.transfer(address(_mToken), 1_000);
    }
